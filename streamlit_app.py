...
if seleccion == "2015":
  ...
  with tab1:
    ...
    col1.image(df_players_15["player_face_url"][1], width=300)
    col1.subheader("Nombre Completo:")
    col1.subheader(df_players_15["long_name"][1])
    col1.divider()
    col1.subheader("Alias:")
    col1.subheader(df_players_15["short_name"][1])
    col2.metric("Valor en Euros", value=int(df_players_15["value_eur"][1]))
